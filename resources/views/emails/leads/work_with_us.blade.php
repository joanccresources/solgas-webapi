...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<p><strong>DNI:</strong> {{ $lead->dni }}</p>
			<p><strong>Teléfono:</strong> {{ $lead->phone }}</p>
			<p><strong>Dirección:</strong> {{ $lead->address }}</p>
			<p><strong>Email:</strong> <a href="mailto:{{ $lead->email }}">{{ $lead->email }}</a></p>
			<p><strong>Fecha de nacimiento:</strong> {{ $lead->birth_date }}</p>
			<p><strong>Área postulada:</strong> {{ $lead->employmentRel->title ?? 'N/A' }}</p>
			<p><strong>CV:</strong> Se visualiza en el CMS</p>
		</div>
		<div class="footer">
