...
class CreateMapServiceStationDto
{
    public function __construct(
        ...
        public int $type_map_id,
        public bool|null $active
    ) {}

    public static function fromRequest(MapServiceStationRequest $request): CreateMapServiceStationDto
    {
        return new self(
            ...
            type_map_id: (int) $request->get('type_map_id'),
