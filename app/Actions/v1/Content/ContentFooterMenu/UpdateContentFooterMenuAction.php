...
class UpdateContentFooterMenuAction
{
    protected $element;
    protected $storage;
    protected $content;
    ...
    public function execute(UpdateContentFooterMenuDto $dto)
    {
        return $this
            ->updateFile($dto)
            ->create($dto)
    ...
    protected function create(UpdateContentFooterMenuDto $dto): self
    {
