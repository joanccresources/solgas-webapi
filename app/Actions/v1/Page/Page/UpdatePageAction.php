...
class UpdatePageAction
{
    ...
    public function execute(UpdatePageDto $dto)
    {
        return $this
            ->createImage($dto)
            ->create($dto)
    ...
    protected function create(UpdatePageDto $dto): self
    {
    ...
    protected function buildResponse($dto): JsonResponse
    {
        return ApiResponse::createResponse()
            ...
            ->withMessage(trans('custom.message.update.success', ['name' => trans('custom.attribute.page')]))
            ->build();
    }
}
