...
class UpdateUserAction
{
    ...
    protected function removeRoles(UpdateUserDto $dto): self
    {
        foreach ($this->element->roles as $value) {
            $this->element->removeRole($value);
        }

        return $this;
    }

    protected function createUser(UpdateUserDto $dto): self
    {
    ...
    protected function buildResponse($dto): JsonResponse
    {
        return ApiResponse::createResponse()
            ...
            ->withMessage(trans('custom.message.update.success', ['name' => trans('custom.attribute.user')]))
            ->build();
    }
}
