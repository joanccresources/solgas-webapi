...
class ContentSocialNetwork extends Model
{
    use HasFactory, LogsActivity;

    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()->logOnly(['url', 'content_master_social_network_id', 'active']);
    }
    ...
    public function masterSocialNetworkRel(): BelongsTo
    {
        return $this->belongsTo(ContentMasterSocialNetwork::class, 'content_master_social_network_id', 'id');
    }
