...
class SustainabilityReport extends Model
{
    ...
    {
        return LogOptions::defaults()->logOnly(['title', 'pdf', 'index', 'active', 'title_milestones']);
    }
    ...
    public function reportObjectsRels(): HasMany
    {
        return $this->hasMany(SustainabilityReportObject::class, 'sustainability_report_id', 'id');
    }
    ...
    protected function pdfFormat(): Attribute
    {
        return new Attribute(
            get: fn() => $this->pdf
                ...
                . DIRECTORY_SEPARATOR . $this->pdf
                : null,
        );
    }

    protected function pdfFormat2(): Attribute
    {
        return new Attribute(
            get: fn() => $this->pdf
                ? DIRECTORY_SEPARATOR . 'public'
