...
class ContentHeader extends Model
{
    ...
    {
        return LogOptions::defaults()->logOnly(['name', 'active']);
    }
    ...
    public function contentHeaderMenuRels(): HasMany
    {
        return $this->hasMany(ContentHeaderMenu::class, 'content_header_id', 'id');
    }
