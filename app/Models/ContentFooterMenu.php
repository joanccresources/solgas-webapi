...
class ContentFooterMenu extends Model
{
    ...
    public function contentFooterRel(): BelongsTo
    {
        return $this->belongsTo(ContentFooter::class, 'content_footer_id', 'id');
    }
    ...
    {
        return $this->belongsTo(ContentFooterMenu::class, 'content_footer_menu_id');
    }
    ...
    {
        return $this->hasMany(ContentFooterMenu::class, 'content_footer_menu_id');
    }
