...
class PageMultipleContent extends Model
{
    use HasFactory;
    ...
    public function multipleFieldRel(): BelongsTo
    {
        return $this->belongsTo(PageMultipleField::class, 'page_multiple_field_id', 'id');
    }
    ...
    {
        return new Attribute(
            get: fn() => $this->json_value ? json_decode($this->json_value, true) : []
        );
    }
}
